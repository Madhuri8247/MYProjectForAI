...
namespace OnlineNews.Migrations
{
    ...
    [Migration("20250306132412_Order_OrderRows_Customerclasses_added")]
    partial class Order_OrderRows_Customerclasses_added
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OnlineNews.Models.Customer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OnlineNews.Models.Database.UserInteractionWithArticle", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("UserInteractionWithArticles");
                });

            modelBuilder.Entity("OnlineNews.Models.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OnlineNews.Models.OrderRow", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OnlineNews.Models.Product", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OnlineNews.Models.Database.UserInteractionWithArticle", b =>
                {
                    b.HasOne("OnlineNews.Models.Database.Article", "Article")
                        .WithMany()
            ...
            modelBuilder.Entity("OnlineNews.Models.Order", b =>
                {
                    b.HasOne("OnlineNews.Models.Customer", "Customer")
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("OnlineNews.Models.OrderRow", b =>
                {
                    b.HasOne("OnlineNews.Models.Order", "Order")
                        .WithMany("OrderRows")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("OnlineNews.Models.Product", "product")
                        .WithMany("OrderRows")
